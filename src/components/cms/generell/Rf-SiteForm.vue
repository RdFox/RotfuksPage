  ...
  <form class="siteform col-12" v-on:submit.prevent="addEntry">
    <b-tabs small ref="tabs" v-model="tabIndex">
      <b-tab title="MarkUp Text">
        <rf-mark-up class="descr" :data="markupDescr"></rf-mark-up>
        <div class="editor">
          <b-form-input textarea class="editor-text-input" v-model="markupText" placeholder="MarkUp Text"></b-form-input>
          <rf-mark-up class="editor-text-output" :data="markupText"></rf-mark-up>
        </div>
      </b-tab>
      <b-tab title="Image">
        <rf-mark-up class="descr" :data="imageDescr"></rf-mark-up>
        <div class="editor">
...
<script>
  ...
  import RfImage from './Rf-Image';
  import RfMarkUp from './Rf-MarkUp';
  import RfVideo from './Rf-Video';
  /**
   * Site Form needs as parameter the very important "contentRef"
